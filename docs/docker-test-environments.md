...
| `armv7l` | `arm32v7/debian:trixie` | Debian 13 (trixie) | `armv7l` | `armhf` |
| `armv5l` | `arm32v5/debian:latest` | Debian 13 (trixie) | `armv7l`* | `armel` |
| `riscv64` | `riscv64/debian:trixie` | Debian 13 (trixie) | `riscv64` | `riscv64` |
| `ppc64le` | `ppc64le/debian:trixie` | Debian 13 (trixie) | `ppc64le` | `ppc64el` |
